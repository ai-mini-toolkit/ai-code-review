...
/**
 * JPA AttributeConverter that encrypts/decrypts SMTP passwords transparently.
...
public class SmtpPasswordConverter implements AttributeConverter<String, String> {
    ...
    public void setEncryptionKey(String key) {
        if (DEFAULT_KEY.equals(key)) {
            log.warn("Using default encryption key for SMTP passwords! Set ENCRYPTION_KEY environment variable for production.");
        }
        SmtpPasswordConverter.encryptionKey = key;
    }
